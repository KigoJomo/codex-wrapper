...
import { IconLayoutSidebarFilled } from '@/components/icons'
		...
		<div
			...
			<div
				...
				<div
					...
					className="flex size-full flex-col bg-sidebar group-data-[variant=floating]:rounded-2xl group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-2 group-data-[variant=floating]:ring-foreground/15 bg-radial from-primary/7.5 via-primary/5 to-primary/2">
					{children}
				</div>
			</div>
		</div>
